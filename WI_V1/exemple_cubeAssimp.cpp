...
*/
    ...
    //Model ourModel(fs::path::path("assets/models/nanosuit/nanosuit.obj"));
    //fs::path = "assets/models/nanosuit/nanosuit.obj";
    //fs::path p1 = "assets/models/nanosuit/nanosuit.obj"; // portable format
   // Model ourModel(fs::path("assets/models/nanosuit/nanosuit.obj"));

   // build and compile shaders
    // -------------------------
   // ShaderB ourShader("shaders/1.model_loading.vs", "shaders/1.model_loading.fs");

    // load models
    // -----------
    //Model ourModel(FileSystem::getPath("resources/objects/nanosuit/nanosuit.obj"));
/*
    ShaderB monS("shaders/1.model_loading.vs.glsl", "shaders/1.model_loading.fs.glsl");

    fs::path p("../GLImac-Template/assets/models/nanosuit/nanosuit.obj");
    std::cout << p << std::endl;
    std::cout << "Current path is " << fs::path(p) << '\n';
    Model ourModel(fs::path(p));
*/
    /**********************************/
    /******* BOUCLE D'AFFICHAGE *******/
    /**********************************/
...
/*
        ...
        monS.setMat4("model", model);
        //ourModel.Draw(monS);
        //std::cout << ourModel.meshes << std::endl;
*/
        glBindVertexArray(0);
        glActiveTexture(GL_TEXTURE0);
        glBindTexture(GL_TEXTURE_2D, 0);
