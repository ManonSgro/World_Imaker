...
int main(int argc, char** argv) {
    ...
    // Camera matrix
    Camera MyCamera(10,10,10,0,0,0,0,1,0);
    //glm::mat4 View2 = MyCamera.build(MyCamera.getRx(), MyCamera.getRy(), MyCamera.getRz(), MyCamera.getUx(), MyCamera.getUy(), MyCamera.getUz(), MyCamera.getDx(), MyCamera.getDy(), MyCamera.getDz());

    glm::mat4 View = MyCamera.build(MyCamera.getRx(),MyCamera.getRy(),MyCamera.getRz(),MyCamera.getUx(),MyCamera.getUy(),MyCamera.getUz(),MyCamera.getDx(),MyCamera.getDy(),MyCamera.getDz());
...
*/
    ...
    // Camera matrix
    Camera MyCamera(3,10,10,0,0,0,0,1,0);
    glm::mat4 View;
    //glm::mat4 View2 = MyCamera.build(MyCamera.getRx(), MyCamera.getRy(), MyCamera.getRz(), MyCamera.getUx(), MyCamera.getUy(), MyCamera.getUz(), MyCamera.getDx(), MyCamera.getDy(), MyCamera.getDz());
    View = MyCamera.build(MyCamera.getRx(),MyCamera.getRy(),MyCamera.getRz(),MyCamera.getUx(),MyCamera.getUy(),MyCamera.getUz(),MyCamera.getDx(),MyCamera.getDy(),MyCamera.getDz());
